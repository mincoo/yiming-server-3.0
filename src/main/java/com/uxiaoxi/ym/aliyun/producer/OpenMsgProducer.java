 ...
 * 2015年3月24日
 */
public class OpenMsgProducer {
 // log
    private Logger LOG = LoggerFactory.getLogger(OpenMsgProducer.class);
    ...
    public void init(){
        ...
        properties.put(PropertyKeyConst.ProducerId, aliyunConfig.getOPENProducerId());
...
public void sendOpenMsg(SchoolCheckForm form,Long uid) {
        ...
        Message msg;
        try {
            msg = new Message(aliyunConfig.getOPENTopic(),tag,jsonString.getBytes("UTF-8"));
            // 构造一个msgkey
