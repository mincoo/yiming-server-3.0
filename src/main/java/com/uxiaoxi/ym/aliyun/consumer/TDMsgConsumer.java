 ...
 * 2015年3月24日
 */
public class TDMsgConsumer {
    
    @Resource(name="td_msgListener")
    ...
    public void init() {
        ...
        properties.put(PropertyKeyConst.ConsumerId, aliyunConfig.getTDConsumerId());
        ...
        consumer.subscribe(aliyunConfig.getTDTopic(), "*", listener);
        consumer.start();
    }
