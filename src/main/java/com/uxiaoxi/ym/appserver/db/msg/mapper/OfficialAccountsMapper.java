...
public interface OfficialAccountsMapper {
     ...
     * @mbggenerated  Mon Feb 22 16:30:28 CST 2016
     */
    int updateByExampleSelective(@Param("record") OfficialAccounts record,
            @Param("example") OfficialAccountsExample example);

    /**
     * This method was generated by MyBatis Generator. This method corresponds to the database table official_accounts
     * @mbggenerated  Mon Feb 22 16:30:28 CST 2016
     */
    int updateByExample(@Param("record") OfficialAccounts record,
            @Param("example") OfficialAccountsExample example);
