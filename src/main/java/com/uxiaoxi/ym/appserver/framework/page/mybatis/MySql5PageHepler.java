...
public class MySql5PageHepler {
    ...
    public static String getCountString(String querySelect) {
        ...
        querySelect= getLineSql(querySelect);//得到sql的偏移量
        int orderIndex  = getLastOrderInsertPoint(querySelect);//得到最后一个Order By的插入点位置
        int formIndex   = getAfterFormInsertPoint(querySelect);//得到SQL第一个正确的FROM的的插入点
